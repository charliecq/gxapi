...
gx_defines = [
    ...
    Define('VV_ORDER',
           doc="Specify if the data is monotonically increasing or decreasing.",
           constants=[
               Constant('VV_ORDER_NONE', value='0', type=Type.INT32_T,
                        doc="There is no specific data size ordering in the VV."),
...
gx_methods = {
    'Miscellaneous': [
        ...
        Method('iGetData_VV', module='geoengine.core', version='5.0.0',
               ...
               doc="Copy data from user memory to a VV",
               ...
               parameters = [
                   ...
                   Parameter('data', type="void*",
                             doc="Data buffer copy data into from VV"),
        ...
        Method('iSetData_VV', module='geoengine.core', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('data', type="const void*",
                             doc="Data buffer to copy into VV"),
                   Parameter('gs_type', type=Type.INT32_T, is_val=True,
                             doc=":def:`GS_TYPES`")
               ]),
        ...
        Method('_Copy2_VV', module='geoengine.core', version='5.0.0',
               ...
               notes="""
               1. Unlike :func:`_Copy_VV` destination VV is not reallocated, nor is
               ...
               parameters = [
                   ...
                   Parameter('p3', type="VV",
                             doc="Source VV (can be the same as Destination)"),
        ...
        Method('_LogLinear_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Take the log10 or original value of a VV.",
               notes="""
        ...
        Method('_Mask_VV', module='geoengine.core', version='5.0.0',
               ...
               doc="Mask one VV against another.",
               notes="""
        ...
        Method('_Reverse_VV', module='geoengine.core', version='5.1.3',
               availability=Availability.LICENSED, 
               doc="Reverses the order of the data in a VV.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Data VV")
        ...
        Method('Abs_VV', module='geoengine.core', version='7.1.0',
               availability=Availability.PUBLIC, 
               doc="Take the absolute value of values in a VV.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV")
               ]),
        ...
        Method('CopyVMtoVV_VV', module='geoengine.core', version='5.0.0',
               ...
               doc="Copy :class:`VM` data to a VV.",
               notes="The VV will be resized to the length of the :class:`VM`.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Destination VV, will be resized to length of the :class:`VM`"),
        ...
        Method('CopyVVtoVM_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, no_cpp=True, 
               doc="Copy VV data to a :class:`VM`.",
               notes="""
               The :class:`VM` will be resized to the length of the VV.
               The pointer to data in the :class:`VM` may move.
               """,
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VM",
                             doc="Destination :class:`VM`, will be resized to length of the VV"),
                   Parameter('p2', type="VV",
                             doc="Source VV")
               ]),
        ...
        Method('CRC_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Compute the CRC value of a VV.",
               return_type="CRC",
        ...
        Method('Create_VV', module='geoengine.core', version='5.0.0',
               ...
               """,
               return_type="VV",
               return_doc="VV Object",
               parameters = [
                   Parameter('p1', type=Type.INT32_T,
                             doc=":def:`GEO_VAR`"),
                   Parameter('p2', type=Type.INT32_T,
                             doc="Maximum number of elements in the VV, >= 0")
               ]),

        Method('CreateExt_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Create a VV, using one of the :def:`GS_TYPES` special data types.",
               notes="""
               See :func:`Create_VV`
        ...
        Method('CreateS_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Create a VV  from serialized source.",
               return_type="VV",
               return_doc="VV Object",
               parameters = [
        ...
        Method('Divide_VV', module='geoengine.core', version='5.0.8',
               availability=Availability.PUBLIC, 
               doc="Divide one VV by another: VV_A / VV_B = VV_C",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV A"),
        ...
        Method('FidNorm_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.LICENSED, 
               doc="Re-sample a pair of VV's to match each other.",
               notes="""
        ...
        Method('FillInt_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Fill a VV with an int value.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Data VV"),
        ...
        Method('FillReal_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Fill a VV with a real value.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Data VV"),
        ...
        Method('FillString_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Fill a VV with a string value.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Data VV"),
        ...
        Method('GetVM_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, no_cpp=True, 
               doc="Get VV data and place it in a :class:`VM`. (OBSOLETE)",
               notes="""
               See :func:`CopyVVtoVM_VV`, which is a prefered method to move VV data
               ...
               of the VV will be set to dummy in the :class:`VM`.
               """,
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV from which to read data"),
                   Parameter('p2', type="VM",
                             doc=":class:`VM` in which to place the data"),
                   Parameter('p3', type=Type.INT32_T,
                             doc="Start VV location of data to get, 0 is first.")
               ]),

        Method('iCountDummies_VV', module='geoengine.core', version='6.3.0',
               availability=Availability.PUBLIC, 
               doc="Count the number of dummies in a VV",
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV to search"),
                   Parameter('p2', type=Type.INT32_T,
                             doc="Starting point in VV (0 for all)"),
                   Parameter('p3', type=Type.INT32_T,
        ...
        Method('iFindDum_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Finds the first dummy or non-dummy value in a VV",
               notes="""
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV to search"),
                   Parameter('p2', type=Type.INT32_T,
                             doc="Lowest element in VV element to search"),
                   Parameter('p3', type=Type.INT32_T,
                             doc="Highest element in VV to search"),
                   Parameter('p4', type=Type.INT32_T,
        ...
        Method('iGetFidExpansion_VV', module='geoengine.core', version='6.4.0',
               availability=Availability.PUBLIC, 
               doc="Gets the Fiducial expansion from a VV",
               return_type=Type.INT32_T,
               return_doc="Number of expanions for this VV (see :func:`ReFidVV_VV`)",
               parameters = [
                   Parameter('p1', type="VV")
               ]),
        ...
        Method('iGetInt_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Get an integer element from a VV.",
               return_type=Type.INT32_T,
               return_doc="""
        ...
        Method('IGetString_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Get a string element from a VV.",
               notes="""
        ...
        Method('iIndexMax_VV', module='geoengine.core', version='6.2.0',
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Points VV (must be one of the 4 supported types)"),
        ...
        Method('iLength_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Returns current VV length.",
               return_type=Type.INT32_T,
               return_doc="# of elements in the VV.",
               parameters = [
                   Parameter('p1', type="VV")
               ]),
        ...
        Method('IndexInsert_VV', module='geoengine.core', version='6.2.0',
               availability=Availability.PUBLIC, 
               doc="Insert items into a VV using an index VV.",
               notes="""
               ...
               Create and initialize an index (0, 1, 2...) VV, using the :func:`InitIndex_VV`
               function, and when you remove
               the dummies, remove the corresponding index values as well.
               After processing, init a VV to dummies, then use :func:`IndexInsert_VV` to
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Output Data VV (modified with inserted data)"),
                   Parameter('p2', type="VV",
                             doc="Data items to insert (must be same type as output data VV)"),
                   Parameter('p3', type="VV",
                             doc="Index VV (must be type INT)")
               ]),
        ...
        Method('InitIndex_VV', module='geoengine.core', version='6.2.0',
               availability=Availability.PUBLIC, 
               doc="Initialize an index VV to values 0, 1, 2, etc...",
               notes="""
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Index VV to initialize (type INT)"),
                   Parameter('p2', type=Type.INT32_T,
                             doc="Final length of VV (-1 to use current length).")
               ]),
        ...
        Method('LinesToXY_VV', module='geoengine.core', version='8.0.0',
               availability=Availability.LICENSED, 
               doc="Convert a 2D Line segment VV into X and Y VVs.",
               notes="""
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Input VV of GS_D2LINE type (create with type -32)"),
                   Parameter('p2', type="VV",
                             doc="Output VV with X locations (:def_val:`GS_DOUBLE`)"),
                   Parameter('p3', type="VV",
                             doc="Output VV with Y locations (:def_val:`GS_DOUBLE`)")
               ]),

        Method('LookupIndex_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.LICENSED, 
               doc="Lookup a VV from another VV using an index VV.",
               notes="""
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Input Data VV (numeric)"),
                   Parameter('p2', type="VV",
                             doc="Index VV of REAL"),
                   Parameter('p3', type="VV",
                             doc="Result VV (same type as Data VV)")
               ]),

        Method('MakeMemBased_VV', module='geoengine.core', version='5.1.2',
               availability=Availability.PUBLIC, 
               doc="Make this VV use regular instead of virtual memory.",
               notes="""
               ...
               the VV through the :func:`GetPtrVV_GEO` function (see gx_extern.h).
               """,
        ...
        Method('MaskStr_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.LICENSED, 
               doc="Mask one VV against another using a string.",
               notes="""
        ...
        Method('PolygonMask_VV', module='geoengine.core', version='5.1.3',
               availability=Availability.LICENSED, 
               doc="Mask a VV using XY data and a polygon",
        ...
        Method('Project_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.LICENSED, 
               doc="This method projects an X and Y VV.",
        ...
        Method('Project3D_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.LICENSED, 
               doc="This method projects an X,Y,Z VV.",
        ...
        Method('RangeDouble_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Get the min. and max. values of a VV while ignoring dummies.",
               notes="Minimum and maximum become :def_val:`GS_R8DM` if entire VV is dummy.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV"),
                   Parameter('p2', type=Type.DOUBLE, is_ref=True,
        ...
        Method('ReFid_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Re-sample a VV to a new fid start/icrement",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV to resample"),
        ...
        Method('ReFidVV_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Re-sample a VV to match another VV.",
               notes="""
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV to resample"),
                   Parameter('p2', type="VV",
                             doc="VV model (fid increment and start)")
               ]),

        Method('ReSample_VV', module='geoengine.core', version='5.1.1',
               availability=Availability.PUBLIC, 
               doc="Resamples a VV from one fid/incr to another fid/incr.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV to resample"),
        ...
        Method('rGetFidIncr_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Gets the Fiducial increment from a VV",
               return_type=Type.DOUBLE,
               return_doc="Fiducial increment of the VV.",
               parameters = [
                   Parameter('p1', type="VV")
               ]),
        ...
        Method('rGetFidStart_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Gets the Fiducial start from a VV",
               return_type=Type.DOUBLE,
               return_doc="Fiducial start of the VV.",
               parameters = [
                   Parameter('p1', type="VV")
               ]),
        ...
        Method('rGetReal_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Get a real element from a VV.",
               notes="""
               Type conversions are performed if necessary.  Dummy values
               are converted to "*" string.
               """,
        ...
        Method('rSum_VV', module='geoengine.core', version='7.2.0',
               availability=Availability.LICENSED, 
               doc="Calculate the sum of the values in a VV.",
        ...
        Method('SetFidExpansion_VV', module='geoengine.core', version='6.4.0',
               availability=Availability.PUBLIC, 
               doc="Sets the Fiducial expansion from a VV",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV"),
                   Parameter('p2', type=Type.INT32_T,
        ...
        Method('SetFidIncr_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Sets the Fiducial increment of a VV",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV to set fiducial increment of"),
                   Parameter('p2', type=Type.DOUBLE,
                             doc="New increment")
               ]),
        ...
        Method('SetFidStart_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Sets the Fiducial start of a VV",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV to set fiducial start of"),
                   Parameter('p2', type=Type.DOUBLE,
                             doc="New start")
               ]),
        ...
        Method('SetInt_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Set an integer element in a VV.",
               notes="""
        ...
        Method('SetIntN_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Set N integer elements in a VV.",
               notes="""
               Element being set cannot be < 0.
               If the element is > current VV length, the VV length is
               increased.
        ...
        Method('SetReal_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Set a real element in a VV.",
               notes="""
               Element being set cannot be < 0.
               If the element is > current VV length, the VV length is
               increased.
        ...
        Method('SetRealN_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Set N real elements in a VV.",
               notes="""
               Element being set cannot be < 0.
               If the element is > current VV length, the VV length is
               increased.
        ...
        Method('SetString_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Set a string element in a VV.",
               notes="""
               Element being set cannot be < 0.
               If the element is > current VV length, the VV length is
               increased.
        ...
        Method('SetStringN_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, 
               doc="Set N string elements in a VV.",
               notes="""
               Element being set cannot be < 0.
               If the element is > current VV length, the VV length is
               increased.
        ...
        Method('SetupIndex_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.LICENSED, 
               doc="Setup an index VV from VV1 to VV2.",
               notes="""
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="Original Data VV"),
                   Parameter('p2', type="VV",
                             doc="Query VV (same type as Data VV)"),
                   Parameter('p3', type="VV",
                             doc="VV index VV of type REAL"),
                   Parameter('p4', type=Type.INT32_T,
                             doc=":def:`VV_LOOKUP`"),
                   Parameter('p5', type=Type.DOUBLE,
        ...
        Method('SetVM_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.PUBLIC, no_cpp=True, 
               doc="Set VV data from a :class:`VM`. (OBSOLETE)",
               notes="""
               ...
               The :class:`VM` will be lengthened if required to hold the entire VV.
               ...
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV in which to place data"),
                   Parameter('p2', type="VM",
                             doc=":class:`VM` from which to read the data"),
                   Parameter('p3', type=Type.INT32_T,
                             doc="Start VV location of data to set, 0 is first.")
               ]),
        ...
        Method('SortIndex_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.LICENSED, 
               doc="Sort index VV based on a data VV.",
               notes="""
               Create an Index VV (of type :def_val:`GS_LONG`) based on a data VV.
        ...
        Method('SortIndex1_VV', module='geoengine.core', version='5.0.2',
               availability=Availability.LICENSED, 
               doc="Sort index VV based on 1 data VV - set orders.",
               notes="""
               Create an Index VV (of type :def_val:`GS_LONG`) based on a data VV.
               This index vv can then be used by the IndexOrder method
        ...
        Method('SortIndex2_VV', module='geoengine.core', version='5.0.2',
               availability=Availability.LICENSED, 
               doc="Sort index VV based on 2 data VVs - set orders.",
               notes="""
               Create an Index VV (of type :def_val:`GS_LONG`) based on a data VV.
               This index vv can then be used by the IndexOrder method
               to order a group of VV's. The individual VVs may be ordered
        ...
        Method('SortIndex3_VV', module='geoengine.core', version='5.0.2',
               availability=Availability.LICENSED, 
               doc="Sort index VV based on 3 data VVs - set orders.",
               notes="""
               Create an Index VV (of type :def_val:`GS_LONG`) based on a data VV.
               This index vv can then be used by the IndexOrder method
               to order a group of VV's. The individual VVs may be ordered
        ...
        Method('SortIndex4_VV', module='geoengine.core', version='5.0.2',
               availability=Availability.LICENSED, 
               doc="Sort index VV based on 4 data VVs - set orders.",
               notes="""
               Create an Index VV (of type :def_val:`GS_LONG`) based on a data VV.
               This index vv can then be used by the IndexOrder method
               to order a group of VV's. The individual VVs may be ordered
        ...
        Method('Statistics_VV', module='geoengine.core', version='5.0.0',
               availability=Availability.LICENSED, 
               doc="Add a VV to a :class:`ST`.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="ST",
                             doc=":class:`ST` Handle"),
                   Parameter('p2', type="VV",
                             doc="VV to add to :class:`ST`")
               ]),

        Method('Subtract_VV', module='geoengine.core', version='5.0.8',
               availability=Availability.PUBLIC, 
               doc="Subtract one VV from another: VV_A - VV_B = VV_C",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV A"),
        ...
        Method('WriteXML_VV', module='geoengine.core', version='8.0.0',
               availability=Availability.LICENSED, 
               doc="Write the VV data as an XML object with bytes and formating.",
               return_type=Type.VOID,
               parameters = [
                   Parameter('p1', type="VV",
                             doc="VV to save"),

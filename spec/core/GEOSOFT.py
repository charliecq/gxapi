...
gx_defines = [
    ...
    Define('GS_TYPES',
           ...
           constants=[
               ...
               Constant('GS_DOUBLE3D', value='11', type=Type.INT32_T,
                        doc="3 x 64-Bit floating point"),
               Constant('GS_FLOAT2D', value='12', type=Type.INT32_T,
                        doc="2 x 32-Bit floating point"),

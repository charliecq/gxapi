...
gx_methods = {
    'Miscellaneous': [
        ...
        Method('iMapsetTest_MVU', module='geoengine.map', version='6.3.0',
               ...
               return_doc="``True`` if the parameters are good.",
               parameters = [
        ...
        Method('Post_MVU', module='geoengine.map', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('vv_z', type="VV",
                             doc="Values to post"),
                   Parameter('dummy', type=Type.BOOL,
                             doc="Do not plot dummy values?"),
                   Parameter('size', type=Type.INT32_T,
                             doc="Numb Size"),
    ...
    'Obsolete': [
        ...
        Method('PlotVoxelSurface3_MVU', module='geoengine.map', version='8.3.0',
               ...
               parameters = [
                   ...
                   Parameter('surface_name', type=Type.STRING,
                             doc="Iso-surface name"),
                   Parameter('create_closed_geosurface_around_voxel', type=Type.BOOL,
                             doc="Create closed geosurface around voxel?"),
                   Parameter('enclose_cells_less_than_surface_value', type=Type.BOOL,
                             doc="Closed geosurface should enclose cells LESS than surface value?"),

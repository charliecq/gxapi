        ...
        Method('IGetSolidPattern_TPAT', module='geoengine.core', version='7.0.0',
               ...
               parameters = [
                   ...
                   Parameter('index', type=Type.INT32_T,
                             doc="Index"),
                   Parameter('code', type=Type.STRING, is_ref=True, size_of_param='code_size',
                             doc="Returned Code"),
                   Parameter('code_size', type=Type.INT32_T, default_length='TPAT_CODE_SIZE',
                             doc="Length of supplied code string variable"),
                   Parameter('label', type=Type.STRING, is_ref=True, size_of_param='label_size',
                             doc="Returned Label"),
                   Parameter('label_size', type=Type.INT32_T, default_length='TPAT_LABEL_SIZE',
                             doc="Length of supplied code string variable"),
                   Parameter('descr', type=Type.STRING, is_ref=True, size_of_param='descr_size',
                             doc="Returned Description"),
                   Parameter('descr_size', type=Type.INT32_T, default_length='TPAT_DESC_SIZE',
                             doc="Length of supplied code string variable"),

...
gx_defines = [
    ...
    Define('TD_ICON',
           doc="TaskDialog Icon",
           constants=[
               Constant('TD_ICON_NONE', value='0', type=Type.INT32_T,
                        doc="No icon."),
               Constant('TD_ICON_WARNING', value='1', type=Type.INT32_T,
                        doc="An exclamation-point icon appears in the task dialog."),
               Constant('TD_ICON_ERROR', value='2', type=Type.INT32_T,
                        doc="A stop-sign icon appears in the task dialog."),
               Constant('TD_ICON_INFORMATION', value='3', type=Type.INT32_T,
                        doc="An icon consisting of a lowercase letter i in a circle appears in the task dialog."),
               Constant('TD_ICON_SUCCESS', value='4', type=Type.INT32_T,
                        doc="A shield icon appears in the task dialog."),
               Constant('TD_ICON_CONFIRMATION', value='5', type=Type.INT32_T,
                        doc="A shield icon appears in the task dialog.")
           ]),

    Define('TD_BUTTON',
           doc="TaskDialog Common Buttons",
           constants=[
...
gx_methods = {
    ...
    'Misc': [
        ...
        Method('LogScriptRun_SYS', module='geoengine.core', version='9.2.0',
               availability=Availability.PUBLIC, 
    ...
    'User Interaction': [
        ...
        Method('iDisplayTaskDialogUI_SYS', module='geoengine.core', version='9.3.0',
               availability=Availability.PUBLIC, 
               doc="Show a Windows TaskDialog UI (see https://msdn.microsoft.com/en-us/library/windows/desktop/bb760441(v=vs.85).aspx).",
               return_type=Type.INT32_T,

    ...
    'Miscellaneous': [
        ...
        Method('IGetCurrentSelection_EDB', module='None', version='5.0.0',
               ...
               parameters = [
                   Parameter('edb', type="EDB",
                             doc=":class:`EDB` Object"),
                   Parameter('db', type=Type.STRING, is_ref=True, size_of_param='p3',
                             doc="Database name"),
                   ...
                   Parameter('line', type=Type.STRING, is_ref=True, size_of_param='p7',
                   ...
                   Parameter('fid', type=Type.STRING, is_ref=True, size_of_param='p9',
                             doc="Fiducial range"),

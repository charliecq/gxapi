    ...
    'Miscellaneous': [
        ...
        Method('ExportGeodatabaseLST_DH', module='geodh', version='7.1.0',
               ...
               parameters = [
                   ...
                   Parameter('feat_class', type=Type.STRING, is_ref=True, size_of_param='feat_class_size',
        ...
        Method('IGetCollarTableDB_DH', module='geodh', version='5.1.2',
               ...
               parameters = [
                   Parameter('dh', type="DH",
                             doc=":class:`DH` object"),
                   Parameter('db', type=Type.STRING, is_ref=True, size_of_param='size',
        ...
        Method('IGetTemplateInfo_DH', module='geodh', version='6.0.0',
               ...
               parameters = [
                   ...
                   Parameter('data_type', type=Type.INT32_T, is_ref=True,
                             doc=":def:`DH_DATA`"),
                   Parameter('file', type=Type.STRING, is_ref=True, size_of_param='file_size',
        ...
        Method('ReSurveyPolFit_DH', module='geodh', version='5.1.2',
               ...
               parameters = [
                   ...
                   Parameter('vv_dip', type="VV",
                             doc="Dip"),
                   Parameter('vv_az', type="VV",
                             doc="Azimuth"),

    ...
    'Miscellaneous': [
        ...
        Method('_TableLook1_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Lookup reference channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output Channel Token     [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('_TableLook2_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('r1_ch', type="DB_SYMB",
                             doc="Primary reference channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('r2_ch', type="DB_SYMB",
                             doc="Secondary reference channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output channel [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('_TableLookI2_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Lookup secondary reference channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output Channel Token [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('_TableLookR2_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Secondary reference value [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output Channel Token [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('r1', type=Type.STRING,
                             doc="Primary reference field name in table"),
        ...
        Method('ADOTableNames_DU', module='geogxx', version='5.0.8',
               ...
               :const:`STR_DB_SYMBOL`; i.e. use
               Creat_VV(-:const:`STR_DB_SYMBOL`, 0), or it will assert.
               """,
               return_type=Type.VOID,
               parameters = [
        ...
        Method('AnSig_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line handle"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Input channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output Analytic Signal channel [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('BaseData_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('in_ch', type="DB_SYMB",
                             doc="Input Channel Token  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('time_ch', type="DB_SYMB",
                             doc="Time Channel Token   [:const:`DB_LOCK_READONLY`]"),
        ...
        Method('BoundLine_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   Parameter('db', type="DB",
                             doc="Database"),
                   Parameter('line', type="DB_SYMB",
                             doc="Line Handle [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('BPFilt_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line handle"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Input channel to filter [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output filtered channel [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('BreakLine_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   Parameter('db', type="DB",
                             doc="Database"),
                   Parameter('line', type="DB_SYMB",
                             doc="Line to be broken up [:const:`DB_LOCK_READONLY`]"),
                   Parameter('chan', type="DB_SYMB",
                             doc="Channel containing line numbers [:const:`DB_LOCK_READONLY`]")
               ]),
        ...
        Method('BSpline_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line handle"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Channel to interpolate [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output interpolated channel [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('CopyLine_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('i_line', type="DB_SYMB",
                             doc="Input Line  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_line', type="DB_SYMB",
                             doc="Output Line [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('CopyLineMasked_DU', module='geogxx', version='5.0.8',
               ...
               For :const:`VVU_PRUNE_DUMMY`, only those items where the mask channel
               ...
               parameters = [
                   Parameter('db', type="DB",
                             doc="Database Object"),
                   Parameter('i_line', type="DB_SYMB",
                             doc="Input  Line Symbol [:const:`DB_LOCK_READONLY`]"),
                   Parameter('mask', type="DB_SYMB",
                             doc="Mask Channel Symbol [:const:`DB_LOCK_READONLY`]"),
                   Parameter('prune', type=Type.INT32_T,
                             doc=":def:`VVU_PRUNE`"),
                   Parameter('o_line', type="DB_SYMB",
                             doc="Output Line Symbol [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('Decimate_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line handle"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Origin Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Destination Channel [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('Distance_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('y_ch', type="DB_SYMB",
                             doc="Y channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output Distance channel [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('Distance3D_DU', module='geogxx', version='8.1.0',
               ...
               parameters = [
                   ...
                   Parameter('z_ch', type="DB_SYMB",
                             doc="Z channel [:const:`DB_LOCK_READONLY`] (can be :const:`NULLSYMB`)"),
        ...
        Method('EditDuplicates_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('fid_num', type=Type.DOUBLE,
                             doc="Fiducial number (required if :const:`DB_DUPEDIT_SINGLE`)")
               ]),
        ...
        Method('Export_DU', module='geogxx', version='5.0.0', cpp_post="1",
               ...
               The :const:`DU_CHANNELS_DISPLAYED` option can be used to export any selection of
        ...
        Method('FFT_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('s_ch', type="DB_SYMB",
                             doc="Space Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('r_ch', type="DB_SYMB",
                             doc="Real Channel  [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Imaginary Channel [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('GetChanDataLST_DU', module='geogxx', version='6.1.0',
               ...
               parameters = [
                   ...
                   Parameter('chan', type="DB_SYMB",
                             doc="Data Channel"),
                   Parameter('mask', type="DB_SYMB",
                             doc="Mask Channel  (can be :const:`NULLSYMB`)"),
                   Parameter('lst', type="LST",
        ...
        Method('Gradient_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('ix_ch', type="DB_SYMB",
                             doc="X Input Channel  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('iy_ch', type="DB_SYMB",
                             doc="Y Input Channel  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('iz_ch', type="DB_SYMB",
                             doc="Z Input Channel  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('ig_ch', type="DB_SYMB",
                             doc="G Input Channel  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('ox_ch', type="DB_SYMB",
                             doc="X Output Channel [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('oy_ch', type="DB_SYMB",
                             doc="Y Output Channel [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('oz_ch', type="DB_SYMB",
                             doc="Z Output Channel [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('GravDrift_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   Parameter('db', type="DB",
                             doc="Database"),
                   Parameter('line', type="DB_SYMB",
                             doc="Line                    [:const:`DB_LOCK_READONLY`]"),
                   Parameter('date', type="DB_SYMB",
                             doc="Date                    [:const:`DB_LOCK_READONLY`]"),
                   Parameter('time', type="DB_SYMB",
                             doc="Local time (on date)    [:const:`DB_LOCK_READONLY`]"),
                   Parameter('read', type="DB_SYMB",
                             doc="Reading                 [:const:`DB_LOCK_READONLY`]"),
                   Parameter('base', type="DB_SYMB",
                             doc="Base                    [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('clos', type="DB_SYMB",
                             doc="Closure error           [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('GravTide_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('lat', type="DB_SYMB",
                             doc="Lat  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('lon', type="DB_SYMB",
                             doc="Long [:const:`DB_LOCK_READONLY`]"),
                   Parameter('date', type="DB_SYMB",
                             doc="Date [:const:`DB_LOCK_READONLY`]"),
                   Parameter('time', type="DB_SYMB",
                             doc="Local time (on date) [:const:`DB_LOCK_READONLY`]"),
                   ...
                   Parameter('tide', type="DB_SYMB",
                             doc="Calculated tide [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('Head_DU', module='geogxx', version='5.0.0',
               ...
               :const:`GS_R8DM` if the line has no data, or if there is a
               problem.
               """,
               return_type=Type.VOID,
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line Symbol"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Channel to correct [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Corrected channel  [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('tb', type="TB",
                             doc="Heading table"),
        ...
        Method('IndexOrder_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line symbol"),
                   Parameter('in_ch', type="DB_SYMB",
                             doc="Ordered index channel (should be int) [:const:`DB_LOCK_READONLY`]"),
                   Parameter('ch', type="DB_SYMB",
                             doc="Channel to reorder [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('LabTemplate_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('sample_type', type=Type.INT32_T,
                             doc="Sample channel element type, recommend -10 for 10-character ASCII, or :const:`GS_LONG` for numbers."),
                   Parameter('data_type', type=Type.INT32_T,
                             doc="Default channel element type, recommend :const:`GS_FLOAT`")
               ]),
        ...
        Method('MakeFid_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line Symbol"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Base channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="New fiducial channel [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('Mask_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line handle"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Channel to mask [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('m_ch', type="DB_SYMB",
                             doc="Mask channel [:const:`DB_LOCK_READONLY`]")
               ]),
        ...
        Method('MergeLine_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   Parameter('db', type="DB",
                             doc="Database"),
                   Parameter('i_line', type="DB_SYMB",
                             doc="Input Line1 [:const:`DB_LOCK_READONLY`]"),
                   Parameter('m_line', type="DB_SYMB",
                             doc="Input Line2 [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_line', type="DB_SYMB",
                             doc="Output Line [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('mode', type=Type.INT32_T,
                             doc=":def:`DU_MERGE`")
        ...
        Method('Move_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('c_ch', type="DB_SYMB",
                             doc="Control channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Result channel  [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('mode', type=Type.INT32_T,
                             doc=":def:`DU_MOVE`")
               ]),
        ...
        Method('NLFilt_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line handle"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Channel to filter [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Output filtered channel [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('Normal_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   Parameter('db', type="DB",
                             doc="Database handle"),
                   Parameter('ch', type="DB_SYMB",
                             doc="Base Channel for normalization.  [:const:`DB_LOCK_READONLY`]"),
        ...
        Method('PolyFill_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('r_chan', type="DB_SYMB",
                             doc="Channel to fill [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('pply', type="PLY",
                             doc="Polygon Object to use"),
        ...
        Method('ProjPoints_DU', module='geogxx', version='6.3.0',
               ...
               parameters = [
                   ...
                   Parameter('iy_ch', type="DB_SYMB",
                             doc="Y Input Channel  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('iz_ch', type="DB_SYMB",
                             doc="Z Input Channel  [:const:`DB_LOCK_READONLY`] (can be DB_NULL_SYMB)"),
                   Parameter('ox_ch', type="DB_SYMB",
                             doc="X Output Channel [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('oy_ch', type="DB_SYMB",
                             doc="Y Output Channel [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('oz_ch', type="DB_SYMB",
                             doc="Z Output Channel [:const:`DB_LOCK_READWRITE`] (can be DB_NULL_SYMB)"),
                   Parameter('i_name_chan', type="DB_SYMB",
                             doc="Input Name Channel   [:const:`DB_LOCK_READONLY`]"),
                   Parameter('i_datum_chan', type="DB_SYMB",
                             doc="Input Datum Channel  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('i_method_chan', type="DB_SYMB",
                             doc="Input Method Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('i_unit_chan', type="DB_SYMB",
                             doc="Input Unit Channel   [:const:`DB_LOCK_READONLY`]"),
                   Parameter('il_datum_chan', type="DB_SYMB",
                             doc="Input Local Datum Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_name_chan', type="DB_SYMB",
                             doc="Output Name Channel  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_datum_chan', type="DB_SYMB",
                             doc="Output Datum Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_method_chan', type="DB_SYMB",
                             doc="Output Method Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_unit_chan', type="DB_SYMB",
                             doc="Output Unit Channel  [:const:`DB_LOCK_READONLY`]"),
                   Parameter('ol_datum_chan', type="DB_SYMB",
                             doc="Output Local Datum Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('error_chan', type="DB_SYMB",
                             doc="Error Channel [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('rDirection_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line Symbol"),
                   Parameter('x_ch', type="DB_SYMB",
                             doc="X reference channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('y_ch', type="DB_SYMB",
                             doc="Y reference channel [:const:`DB_LOCK_READONLY`]")
               ]),
        ...
        Method('ReFid_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line Symbol"),
                   Parameter('in_ch', type="DB_SYMB",
                             doc='Original Channel [:const:`DB_LOCK_READONLY`]  "Y" values'),
                   Parameter('ref_ch', type="DB_SYMB",
                             doc='Reference Channel [:const:`DB_LOCK_READONLY`] "X" locations'),
                   Parameter('out_ch', type="DB_SYMB",
                             doc="Output Channel [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('mode', type=Type.INT32_T,
                             doc=":def:`DU_REFID`"),
                   Parameter('start', type=Type.DOUBLE,
                             doc="Start Fid, if :const:`GS_R8DM`, use ref channel minimum"),
                   Parameter('incr', type=Type.DOUBLE,
                             doc="Fid increment, if :const:`GS_R8DM` use nominal spacing of the reference channel."),
        ...
        Method('ReFidAllCh_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line Symbol"),
                   Parameter('ref_ch', type="DB_SYMB",
                             doc="Reference Channel [:const:`DB_LOCK_READONLY`]")
               ]),
        ...
        Method('ReFidCh_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('ref_ch', type="DB_SYMB",
                             doc="Reference Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('ch', type="DB_SYMB",
                             doc="Channel to refid  [:const:`DB_LOCK_READWRITE`]")
               ]),
        ...
        Method('Rotate_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('in_x_ch', type="DB_SYMB",
                             doc="Input X channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('in_y_ch', type="DB_SYMB",
                             doc="Input Y channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('out_x_ch', type="DB_SYMB",
                             doc="Output X channel [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('out_y_ch', type="DB_SYMB",
                             doc="Output Y channel [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('SampleGD_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('iy_ch', type="DB_SYMB",
                             doc="Y Input Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Z Output Channel sampled from :class:`GD` [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('SampleIMG_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('iy_ch', type="DB_SYMB",
                             doc="Y Input Channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('o_ch', type="DB_SYMB",
                             doc="Z Output Channel sampled from :class:`IMG` [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('img', type="IMG",
        ...
        Method('Sort_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line symbol"),
                   Parameter('ch', type="DB_SYMB",
                             doc="Channel to sort [:const:`DB_LOCK_READONLY`]"),
        ...
        Method('SortIndex_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('ch', type="DB_SYMB",
                             doc="Channel to sort [:const:`DB_LOCK_READONLY`]"),
                   Parameter('in_ch', type="DB_SYMB",
                             doc="Output index channel (should be int) [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('sort', type=Type.INT32_T,
                             doc=":def:`DU_SORT`")
               ]),
        ...
        Method('SortIndex2_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('ch1', type="DB_SYMB",
                             doc="Sort by this channel [:const:`DB_LOCK_READONLY`]"),
                   Parameter('sort1', type=Type.INT32_T,
                             doc=":def:`DU_SORT`"),
                   Parameter('ch2', type="DB_SYMB",
                             doc="Then by this channel [:const:`DB_LOCK_READONLY`]"),
        ...
        Method('SplitLine_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   Parameter('db', type="DB",
                             doc="Database"),
                   Parameter('i_line', type="DB_SYMB",
                             doc="Input Line, will be reduced at fid  [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('o_line', type="DB_SYMB",
                             doc="Output Line, will take data above fid [:const:`DB_LOCK_READWRITE`]"),
        ...
        Method('SplitLineXY_DU', module='geogxx', version='8.3.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line to be broken up [:const:`DB_LOCK_READONLY`]"),
                   Parameter('x_ch', type="DB_SYMB",
                             doc="Channel X [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('y_ch', type="DB_SYMB",
                             doc="Channel Y [:const:`DB_LOCK_READWRITE`]"),
                   ...
                   Parameter('first_line', type=Type.INT32_T, is_ref=True,
                             doc="First line in the sequence, for :const:`DU_SPLITLINE_SEQUENTIAL`. On return, the next line in the sequence."),
                   Parameter('line_inc', type=Type.INT32_T,
                             doc="Increment in the line number sequence, for :const:`DU_SPLITLINE_SEQUENTIAL`")
               ]),
        ...
        Method('SplitLineXY3_DU', module='geogxx', version='9.0.0',
               ...
               parameters = [
                   ...
                   Parameter('retain_line_type', type=Type.INT32_T,
                             doc="Maintain line types for :const:`DU_SPLITLINE_SEQUENTIAL`  (0: No, 1: Yes)"),
                   Parameter('reset_fi_ds', type=Type.INT32_T,
                             doc="Reset starting fiducials to zero (0: No, 1: Yes)")
               ]),
        ...
        Method('SplitLineByDirection_DU', module='geogxx', version='8.5.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line to be broken up [:const:`DB_LOCK_READONLY`]"),
                   Parameter('x_ch', type="DB_SYMB",
                             doc="X Channel [:const:`DB_LOCK_READWRITE`]."),
                   Parameter('y_ch', type="DB_SYMB",
                             doc="Y Channel [:const:`DB_LOCK_READWRITE`]."),
                   ...
                   Parameter('minimum_line_length', type=Type.DOUBLE,
                             doc="Delete lines shorter than (can be :const:`rDUMMY`)"),
                   Parameter('break_on_separation_distance', type=Type.DOUBLE,
                             doc="Break on data XY separation greater than (can be :const:`rDUMMY`)"),
        ...
        Method('Stat_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line', type="DB_SYMB",
                             doc="Line handle"),
                   Parameter('i_ch', type="DB_SYMB",
                             doc="Channel handle [:const:`DB_LOCK_READONLY`]"),
        ...
        Method('TimeConstant_DU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('resp_chan', type="DB_SYMB",
                             doc="Response channel, required [:const:`DB_LOCK_READONLY`]"),
                   Parameter('time_chan', type="DB_SYMB",
                             doc="Time channel, required [:const:`DB_LOCK_READONLY`]"),
                   Parameter('tau_chan', type="DB_SYMB",
                             doc="Output Time constant (Tau) channel, required [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('intercept_chan', type="DB_SYMB",
                             doc="Output Intercept channel, no output if :const:`NULLSYMB` [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('fit_chan', type="DB_SYMB",
                             doc="Output predicted response channel, no output if :const:`NULLSYMB` [:const:`DB_LOCK_READWRITE`] Result is based on least square fit from Tau and Intercept"),
        ...
        Method('UpdateIntersectDB_DU', module='geogxx', version='7.1.0',
               ...
               parameters = [
                   ...
                   Parameter('x_chan', type="DB_SYMB",
                             doc="X Channel [:const:`DB_LOCK_READONLY`] (for location info)"),
                   Parameter('z_chan', type="DB_SYMB",
                             doc="Z Channel [:const:`DB_LOCK_READONLY`]"),
        ...
        Method('VoxelSection_DU', module='geogxx', version='6.4.0',
               ...
               The grid cell sizes can be left as :const:`GS_R8DM`, in which
        ...
        Method('CreateDrillholeParameterWeightConstraintDatabase_DU', module='geogxx', version='8.2.0',
               ...
               parameters = [
                   ...
                   Parameter('ch', type="DB_SYMB",
                             doc="Property channel handle [:const:`DB_LOCK_READONLY`]"),
                   Parameter('reg', type="REG",
        ...
        Method('CalculateDrapedSurveyAltitude_DU', module='geogxx', version='8.3.0',
               ...
               parameters = [
                   ...
                   Parameter('img', type="IMG",
                             doc="Topography grid"),
                   Parameter('z_ch', type="DB_SYMB",
                             doc="Output draped altitude channel [:const:`DB_LOCK_READWRITE`]"),
                   ...
                   Parameter('min_curvature', type=Type.DOUBLE,
                             doc="Minimum radius of curvature down slopes and at valley bottoms (:const:`rDUMMY` to disable)")
               ]),
        ...
        Method('CalculateDrapedSurveyAltitude2_DU', module='geogxx', version='8.4.0',
               ...
               parameters = [
                   ...
                   Parameter('dem_ch', type="DB_SYMB",
                             doc="Output DEM channel [:const:`DB_LOCK_READWRITE`] (can be :const:`NULLSYMB` if not required)"),
                   Parameter('z_ch', type="DB_SYMB",
                             doc="Output draped altitude channel [:const:`DB_LOCK_READWRITE`]"),
                   Parameter('ascent', type=Type.DOUBLE,
                             doc="Maximum rate of ascent (%)"),

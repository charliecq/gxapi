    ...
    'Miscellaneous': [
        ...
        Method('EMHalfSpaceInv_GU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('vv_quadrature', type="VV",
                             doc="Quadrature part (ppm)"),
                   Parameter('vv_res', type="VV",
                             doc="On return - inverted halfspace resistivities"),
                   Parameter('inv', type=Type.INT32_T,
                             doc=":def:`EM_INV`"),
        ...
        Method('Geometrics2DB_GU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('line_dir', type=Type.INT32_T,
                             doc="Survey line orientation:  North-south - 0 East-west   - 1"),
                   Parameter('corner', type=Type.INT32_T,
                             doc="Starting survey position: SW - 0, NW - 1, SE - 2, NE - 3,"),
                   Parameter('bi_uni', type=Type.INT32_T,
                             doc="Bidirectional (0) or Unidirectional (1)"),
                   Parameter('corner_x', type=Type.DOUBLE,
                             doc="Starting position X"),
                   Parameter('corner_y', type=Type.DOUBLE,
                             doc="Starting position Y"),
                   Parameter('mark_space', type=Type.DOUBLE,
                             doc="Mark spacing"),
                   Parameter('line_space', type=Type.DOUBLE,
                             doc="Line spacing")
               ]),
        ...
        Method('iEMLayer_GU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('vv_thickness', type="VV",
                             doc="sNLayer-1 thicknesses  [0] to [sNLayer-2]"),
                   Parameter('vv_sigma', type="VV",
                             doc="sNLayer conductivities [0] to [sNLayer-1]"),
                   Parameter('in_phase', type=Type.DOUBLE, is_ref=True,
                             doc="On return - in-phase part (ppm)"),
                   Parameter('quadrature', type=Type.DOUBLE, is_ref=True,
        ...
        Method('iEMPlate_GU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('dip_length', type=Type.DOUBLE,
                   ...
                   Parameter('plate_depth', type=Type.DOUBLE,
                             doc="Depth below Tx"),
                   Parameter('n_spons', type=Type.INT32_T,
                             doc=":def:`EMPLATE_DOMAIN`"),
                   Parameter('sig_tvv', type="VV",
        ...
        Method('MaxwellPlateCorners_GU', module='geogxx', version='6.1.0',
               ...
               parameters = [
                   ...
                   Parameter('z4', type=Type.DOUBLE, is_ref=True,

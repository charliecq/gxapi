        ...
        Method('Scatter2_CHIMERA', module='geochimera', version='5.0.7',
               ...
               parameters = [
                   ...
                   Parameter('height', type=Type.DOUBLE,
                             doc="Box height"),
                   Parameter('horz_vv', type="VV",
                             doc="Horizontal channel"),
                   Parameter('vert_vv', type="VV",
                   ...
                   Parameter('sym_num_vv', type="VV",
                             doc="Symbol numbers"),
                   Parameter('sym_siz_vv', type="VV",
                             doc="Symbol sizes"),
                   Parameter('sym_col_vv', type="VV",
                             doc="Colors  if symbol number or Color == 0, do not plot"),
                   Parameter('annot_style', type=Type.INT32_T,
                             doc="Annotation style 0 - outside, 1 - inside"),
                   Parameter('h_chan', type=Type.STRING,
                             doc="Horizontal channel name"),
                   Parameter('v_chan', type=Type.STRING,
                             doc="Vertical channel name"),
                   Parameter('h_units', type=Type.STRING,
                   ...
                   Parameter('v_max', type=Type.DOUBLE,
                             doc="Max. Vertical value"),
                   Parameter('hr_min', type=Type.DOUBLE,
                             doc="Min. Horizontal range value"),
                   Parameter('hr_max', type=Type.DOUBLE,
                             doc="Max. Horizontal range value"),
                   Parameter('vr_min', type=Type.DOUBLE,
                             doc="Min. Vertical range value"),
                   Parameter('vr_max', type=Type.DOUBLE,
                             doc="Max. Vertical range value"),
                   Parameter('use_hr_min', type=Type.INT32_T,
                             doc="Use Min Horz. Range selection?"),
                   Parameter('use_hr_max', type=Type.INT32_T,
                             doc="Use Max Horz. Range selection?"),
                   Parameter('use_vr_min', type=Type.INT32_T,
                             doc="Use Min Vert. Range selection?"),
                   Parameter('use_vr_max', type=Type.INT32_T,
                             doc="Use Max Vert. Range selection?"),
                   Parameter('h_scaling', type=Type.INT32_T,
                             doc="Horizontal axis scaling: 0 - linear, 1 - log"),
                   Parameter('v_scaling', type=Type.INT32_T,
                             doc="Vertical axis scaling: 0 - linear, 1 - log")
               ]),
        ...
        Method('TriPlot2_CHIMERA', module='geochimera', version='5.1.6',
               ...
               parameters = [
                   ...
                   Parameter('z_chan', type=Type.STRING,
                             doc="Z channel name"),
                   Parameter('xr_min', type=Type.DOUBLE,
                             doc="Min. X range value"),
                   Parameter('xr_max', type=Type.DOUBLE,
                             doc="Max. X range value"),
                   Parameter('yr_min', type=Type.DOUBLE,
                             doc="Min. Y range value"),
                   Parameter('yr_max', type=Type.DOUBLE,
                             doc="Max. Y range value"),
                   Parameter('zr_min', type=Type.DOUBLE,
                             doc="Min. Z range value"),
                   Parameter('zr_max', type=Type.DOUBLE,
                             doc="Max. Z range value"),
                   Parameter('use_xr_min', type=Type.INT32_T,
                             doc="Use Min X Range selection?"),
                   Parameter('use_xr_max', type=Type.INT32_T,
                             doc="Use Max X Range selection?"),
                   Parameter('use_yr_min', type=Type.INT32_T,
                             doc="Use Min Y Range selection?"),
                   Parameter('use_yr_max', type=Type.INT32_T,
                             doc="Use Max Y Range selection?"),
                   Parameter('use_zr_min', type=Type.INT32_T,
                             doc="Use Min Z Range selection?"),
                   Parameter('use_zr_max', type=Type.INT32_T,

    ...
    'Miscellaneous': [
        ...
        Method('CreateEx_TC', module='geogxx', version='6.2.0',
               ...
               parameters = [
                   ...
                   Parameter('opt', type=Type.INT32_T,
                             doc=":def:`TC_OPT`"),
                   Parameter('survey_type', type=Type.INT32_T,

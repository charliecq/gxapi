    ...
    'General': [
        ...
        Method('Bool_PGU', module='geogxx', version='5.0.0', cpp_post="_mask",
               ...
               parameters = [
                   Parameter('pg', type="PG",
                             doc="Pager obj"),
                   Parameter('ref_fil', type=Type.STRING,
        ...
        Method('Fill_PGU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('fl_mxp', type=Type.INT32_T,
                             doc="lMxp - max. pred. sample 0 for the default of 2*lMxf."),
                   Parameter('fl_amp_lmt', type=Type.DOUBLE,
                   ...
                   Parameter('fl_npass', type=Type.INT32_T,
        ...
        Method('PeakednessGrid_PGU', module='geogxx', version='5.0.8',
               ...
               return_type=Type.VOID,
               parameters = [
                   Parameter('grdi', type=Type.STRING,
    ...
    'Math Operations': [
        ...
        Method('AddScalar_PGU', module='geogxx', version='7.1.0',
               ...
               parameters = [
                   Parameter('pg', type="PG",
                             doc="Pager"),
                   Parameter('scalar', type=Type.DOUBLE,
                             doc="Scalar Value")
               ]),
    ...
    'Specialized Operations': [
        ...
        Method('rMaximumTerrainSteepness_PGU', module='geogxx', version='7.1.0',
               ...
               parameters = [
                   ...
                   Parameter('annular_size', type=Type.INT32_T,
                             doc="Annular Size")
               ])
    ],
    'Miscellaneous': [
        ...
        Method('FFT2Filter_PGU', module='geogxx', version='5.0.0',
               ...
               parameters = [
                   ...
                   Parameter('d_dy', type=Type.DOUBLE,
                             doc="rDy - Y increment"),
                   Parameter('d_rot', type=Type.DOUBLE,

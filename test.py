...
class GX3DN:
    ...
    def set_render_controls(self, p2: int, p3: int, p4: str, p6: str, p8: str) -> None:
        """
        Get the rendering controls
...
class GXVV:
    ...
    @classmethod
    def create(cls, type: int, elements: int):
        return GXVV(g_cy.WrapVV.create(type, elements))


    def fill_double(self, value: float):
        self._wrapper.fill_double(value)

    def get_data(self, start: int, num_elements: int, b: type(bytearray), type: int):
